    ...
    $.slickQuiz = function(element, options) {
        ...
        plugin.method = {
            ...
            setupQuiz: function() {
                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        questionHTML.append('<h3 class="questionLine">' + count + '. ' + question.q + '</h3>');
            ...
            checkAnswer: function(checkButton) {
                ...
                if (correctResponse) {
                    var tempImgSrc = $("body").css("background-image");
                    //alert(tempImgSrc);

                    tempImgSrc = tempImgSrc.split("/img/");
                    tempImgSrc = tempImgSrc[1].split('"');
                    //alert(tempImgSrc[0]);
                    changeImage(tempImgSrc[0]);
            ...
            completeQuiz: function() {
                ...
                $("body").css("background-image", "url('img/lastBg.png')");
                $("#page").prepend("<a href='' style=\"font-size:30px;font-family:'Comic Sans MS';position:absolute;padding-top:470px;padding-left:560px\">Retry</a>");
                }
...
function changeImage(temp1) {
    if (temp1 == "firstBg.png") {       
        $("body").css("background-image", "url('img/secondBg.png')");
    } else if (temp1 == "secondBg.png") {
        $("body").css("background-image", "url('img/thirdBg.png')");
    } else if (temp1 == "thirdBg.png") {
        $("body").css("background-image", "url('img/fourBg.png')");
    } else if (temp1 == "fourBg.png") {
        $("body").css("background-image", "url('img/fiveBg.png')");
    } else if (temp1 == "fiveBg.png") {
        $("body").css("background-image", "url('img/sixBg.png')");
    } else if (temp1 == "sixBg.png") {
        $("body").css("background-image", "url('img/sevenBg.png')");
    } else if (temp1 == "sevenBg.png") {
        $("body").css("background-image", "url('img/eightBg.png')");
    } else if (temp1 == "eightBg.png") {
        $("body").css("background-image", "url('img/nineBg.png')");
    } else if (temp1 == "nineBg.png") {
        $("body").css("background-image", "url('img/tenBg.png')");
    } else if (temp1 == "tenBg.png") {
        $("body").css("background-image", "url('img/elevenBg.png')");
    }
}
